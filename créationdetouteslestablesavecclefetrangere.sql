...
INSERT INTO `tableprojet`.`client` (`idClient`,`nom`,`prenom`,`adresse`,`ville`,`date_naissance`,`numeroDeTelephone`,`adresseEmail`,`estCreateur`,`capitalCooks`,`motDePasse`) VALUES (1,'Claude','Jean','rue de la paie','bourg','1957-11-24',0674586954,'jean.claude@orange.fr',0,0,'1234');
INSERT INTO `tableprojet`.`client` (`idClient`,`nom`,`prenom`,`adresse`,`ville`,`date_naissance`,`numeroDeTelephone`,`adresseEmail`,`estCreateur`,`capitalCooks`,`motDePasse`) VALUES (2,'Morin','Loic','rue du tarpin','marseille','1999-04-18',0685314692,'morin.loic@gmail.fr',0,10000,'caca');
INSERT INTO `tableprojet`.`client` (`idClient`,`nom`,`prenom`,`adresse`,`ville`,`date_naissance`,`numeroDeTelephone`,`adresseEmail`,`estCreateur`,`capitalCooks`,`motDePasse`) VALUES (3,'Meynet','Florian','rue de la boulangerie','perrognier','1998-02-17',067458365,'meynet.florian@orange.fr',0,10000,'mdpfacile');
INSERT INTO `tableprojet`.`client` (`idClient`,`nom`,`prenom`,`adresse`,`ville`,`date_naissance`,`numeroDeTelephone`,`adresseEmail`,`estCreateur`,`capitalCooks`,`motDePasse`) VALUES (4,'Admin','Admin','ESILV','PARIS','0000-00-00',0000,'admin',1,1000000,'mdpfacile');
...
INSERT INTO `tableprojet`.`ingredient` (`idIngredient`,`idFournisseur`,`nom`,`categorie`,`prixUnité`,`stockMini`,`stockActuel`,`stockMax`) VALUES (1,1,'Biere','boisson',2,10,50,200);
INSERT INTO `tableprojet`.`ingredient` (`idIngredient`,`idFournisseur`,`nom`,`categorie`,`prixUnité`,`stockMini`,`stockActuel`,`stockMax`) VALUES (2,3,'Thai','riz',2.74,2,10,20);
INSERT INTO `tableprojet`.`ingredient` (`idIngredient`,`idFournisseur`,`nom`,`categorie`,`prixUnité`,`stockMini`,`stockActuel`,`stockMax`) VALUES (3,3,'Long','riz',1.99,2,10,20);
INSERT INTO `tableprojet`.`ingredient` (`idIngredient`,`idFournisseur`,`nom`,`categorie`,`prixUnité`,`stockMini`,`stockActuel`,`stockMax`) VALUES (4,4,'Spaghetti','pate',3,2,10,20);
INSERT INTO `tableprojet`.`ingredient` (`idIngredient`,`idFournisseur`,`Nom`,`categorie`,`prixUnité`,`stockMini`,`stockActuel`,`stockMax`) VALUES (5,4,'Carotte','legume',1.14,2,5,10);
